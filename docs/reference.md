...
string-derived numeric functions such as `LENGTH_FUNCTION`, `BOOLEAN_LITERAL`,
...
`LIKE_EXPRESSION`, `CONCAT_EXPRESSION`, and `LENGTH_FUNCTION` matching,
