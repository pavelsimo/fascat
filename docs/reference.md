...
conditional/effectivity-assignment wrappers, including
`CONDITIONAL_CONCEPT_FEATURE`, `CONDITIONAL_EFFECTIVITY`, and
`CONFIGURED_EFFECTIVITY_ASSIGNMENT`, also gate their configured target labels.
