...
| `fascat runtime-fixtures runtime-parity/` | Write bundled browser/Unity/Unreal material, lighting, and KTX2/Basis fallback parity GLBs, software baselines, and a manifest |
