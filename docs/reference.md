...
reference edges; visual annotation geometry remains planned. Report steps also
include detected STEP design variant configuration/effectivity metadata when
