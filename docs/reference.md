...
| Export and budgets | Implemented for USD, USDZ, glTF/GLB, OBJ, STL | `write` report includes glTF runtime dependencies, file size, and optional budget warnings | Add geometry/texture/metadata size breakdowns and export cleanup for unused resources |
