...
- [~] Typed AP242 PMI extraction plus optional visual annotation geometry: common textual AP242 dimension, geometric-tolerance, datum, feature-control-frame, and note records become typed `PmiAnnotation` metadata with a STEP semantic reference graph; full AP242 semantic coverage and visual annotation geometry remain open. Updated 2026-06-01.
